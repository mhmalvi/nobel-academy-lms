...
@section('content')
    <div class="container-xl">
        <form action="{{route('admin.instructor.add')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="course_id">Course(s) <small class="text-danger">*</small></label>
                                    <select name="course_id[]" class="form-control" id="courses" multiple>
...
@push('js')
    ...
    <script>
        $(document).ready(function(){
            $("#courses").select2({
                placeholder: 'Select course(s) to assign'
            });
        })
