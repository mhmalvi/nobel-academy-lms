...
<div class="animated fadeIn">
    <form action="{{route('admin.course.update', $course->id)}}" method="post" enctype="multipart/form-data" id="courseUpdateForm">
        @csrf
        @method('put')
        <div class="row">
            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" class="form-control">
                                ...
                                @forelse ($categories as $item)
                                    <option value="{{$item->id}}" {{($item->id == $course->course_category_id) ? 'selected' : ''}}>
                                        {{$item->category_name}}
                                    </option>
                                @empty
                        ...
                        <div class="form-group">
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url({{($course->course_thumbnail)? asset('storage/courses/'.$course->course_thumbnail) : asset('assets/admin/thumb.png')}});">
                                    </div>
                                </div>
                            </div>
                            @error('image')
