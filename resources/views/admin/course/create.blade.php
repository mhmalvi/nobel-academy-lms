                    ...
                    <div class="ibox-content">
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input type="text" name="course_name" class="form-control" placeholder="Course title..."value="{{old('course_name')}}" required/>
                                @error('course_name')
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="form-group">
                            ...
                            <input type="text" name="course_code" class="form-control" placeholder="Short code of the course..." value="{{old('course_code')}}" required/>
                            @error('course_code')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="units" class="form-control" placeholder="Total course units..."value="{{old('units')}}"/>
                            @error('units')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="title">Course Files ( .pdf |.docx |.ppt )</label>
